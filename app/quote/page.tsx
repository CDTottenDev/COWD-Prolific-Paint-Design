...
export default function QuotePage() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <ParallaxSection
        imageUrl="/placeholder.svg?height=1080&width=1920&query=person writing estimate for house painting, high quality"
        height="h-[50vh]"
        overlayOpacity={0.6}
      >
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-4xl">
          ...
          <div className="bg-gray-50 p-6 md:p-8 lg:p-10 rounded-lg border">
            <QuoteForm />
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <blockquote className="bg-gray-50 p-6 rounded-lg border">
